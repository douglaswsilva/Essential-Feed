...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPreviouslyInsertedCacheValues() {
        ...
        XCTAssertNil(latestInsertionError, "Expect to override cahce successfully")
    ...
    func test_delete_emptiesPriviouslyInsertedCache() {
        let sut = makeSUT()
    ...
    func test_delete_deliversErrorOnDeletionError() {
        let noDeletePermissionURL = cachesDirectoryNoPermission()
    ...
    private func cachesDirectoryNoPermission() -> URL {
